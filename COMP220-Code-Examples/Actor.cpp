...
Actor::Actor(std::string meshName, Material* mat, glm::vec3 position, glm::vec3 rotation )
{
	programID = mat->programID;
	ActorBase(position, rotation);
	loadMeshFromFile(MODELS_FOLDER + meshName, mesh);
